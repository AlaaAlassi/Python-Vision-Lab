...
#------------------------------------------------------------------
training_xml_path = os.path.join(faces_folder, "BlackSquare2.xml")
#testing_xml_path = os.path.join(faces_folder, "BlackSquareTest2.xml")
#------------------------------------------------------------------
...
# dlib.
#-------------------------
dlib.train_simple_object_detector(training_xml_path, "detector2.svm", options)
#------------------------
...
detector = dlib.simple_object_detector("detector2.svm")
...
testfolder = '/home/alaa/Documents/github/Python-Vision-Lab/BlackSquarePatteren2/testSet'
win = dlib.image_window()
for f in glob.glob(os.path.join(testfolder, "*.jpeg")):
...
#image = dlib.load_rgb_image(faces_folder + '/00425_left_image_rect_color.jpeg')
...
#-------------------------------------------------------------
#images = [dlib.load_rgb_image(faces_folder + '/00425_left_image_rect_color.jpeg'),
#          dlib.load_rgb_image(faces_folder + '/00425_left_image_rect_color.jpeg')]
#--------------------------------------------------------------
